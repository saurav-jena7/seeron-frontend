        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2">
              {/* Link to class-subject assignment (Step 1 of Academic Setup) */}
        ...
        {isAdmin && (
          <Modal open={open} onClose={() => setOpen(false)} title={editing ? 'Edit Subject' : 'Add Subject'} size="sm">
            <form onSubmit={handleSubmit} className="space-y-4">
              <Input label="Subject Name *" value={form.name} onChange={e => setForm(p => ({ ...p, name: e.target.value }))} required placeholder="e.g. Mathematics" />
              <Input label="Subject Code" value={form.code} onChange={e => setForm(p => ({ ...p, code: e.target.value }))} placeholder="e.g. MATH" hint="Short identifier used in timetables" />
